...
<div class="w3-top">
  <nav class="w3-bar w3-theme w3-top w3-left-align w3-large">
    ...
    <a href="home.php"><img src="images/IMG11813320842.png" style="height: 43px; width: 43px; margin:5px 3px 0px 5px;" align="left"></a>
    <a href="home.php" class="w3-bar-item w3-button w3-theme-l1" style="margin:5px;"><i class="fa fa-home fa-fw fa-fh"></i>&nbsp;Home</a>
    ...
    <a href="home.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white w3-hide" onclick="signOut()" id="logout" style="margin:5px;  border: 1px solid red;"><i class="fa fa-sign-out fa-fw"></i>&nbsp;Sign Out</a>
...
<div id="navDemo" class="w3-bar-block w3-theme-d2 w3-hide w3-hide-large w3-hide-medium w3-large">
  ...
  <a href="#" class="w3-bar-item w3-button w3-padding-large">Browse</a>
  <a href="/match/match.php" class="w3-bar-item w3-button w3-padding-large">Messages</a>
  <a href="help.html" class="w3-bar-item w3-button w3-padding-large">About</a>
  <a href="home.php" class="w3-bar-item w3-button w3-padding-large" onclick="signOut()" id="logout">Sign Out</a>
</div>