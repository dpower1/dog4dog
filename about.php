        ...
        <div class="w3-col m12">
          <div class="w3-card-2 w3-round w3-white">
            <div class="w3-container w3-padding">
              ...
              <p align="center"> Welcome to Dog4Dog! This service is for dog owners to find other dog
              ...
              <p align="center"> Once your profile is all set to go, you can navigate
                                ...
                                they are interested in each other, then we will pair you canine-lovers
                                up. Feel free to chat with the person to settle the date info!</p>
            </div>
          </div>
        </div>
      </div>
