...
<!-- Main content -->
<body>
<main class="w3-main w3-padding-64 w3-display-container" style="margin-top: 60px">
  <div class="w3-third w3-display-topleft w3-container">
  ...
  <section class="w3-container w3-center w3-justify">
